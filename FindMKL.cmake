...
if(NOT MKL_LIBRARIES)
  ...
  #     set(${TARGET_PARAM}
  #         "${${DEFAULT_PARAM}}"
  #         CACHE STRING "Choose ${TARGET_PARAM} options are: ${${SUPPORTED_LIST}}")
  ...
  # if(CXX_COMPILER_NAME STREQUAL "dpcpp"
  #    OR CXX_COMPILER_NAME STREQUAL "dpcpp.exe"
  #    OR CXX_COMPILER_NAME STREQUAL "icpx"
  #    OR CXX_COMPILER_NAME STREQUAL "icx.exe")
  ...
  # Define MKL_THREADING All APIs support sequential threading
  ...
  # elseif(
  #   GNU_C_COMPILER
  #   OR GNU_Fortran_COMPILER
  #   OR CLANG_COMPILER)
  #   list(APPEND MKL_THREADING_LIST gnu_thread)
  # else()
  #   # Intel and Microsoft compilers Nothing to do, only for completeness
  # endif()
  ...
  if(WIN32
     AND CMAKE_BUILD_TYPE MATCHES "Debug|DebInfo"
     AND MKL_THREADING STREQUAL "tbb_thread")
  ...
  foreach(lib ${MKL_LIBRARIES})
    ...
    if(WIN32 AND NOT MKL_LINK STREQUAL "static")
      ...
      file(GLOB MKL_DLL_FILE "${MKL_ROOT}/redist/${MKL_ARCH}/${MKL_DLL_GLOB}" "${MKL_ROOT}/../redist/${MKL_ARCH}/${MKL_DLL_GLOB}"
           "${MKL_ROOT}/../redist/${MKL_ARCH}/mkl/${MKL_DLL_GLOB}")
      if(NOT ${lib} STREQUAL ${MKL_IFACE_LIB}
         AND NOT ${lib} STREQUAL ${MKL_BLAS95}
         AND NOT ${lib} STREQUAL ${MKL_LAPACK95}) # Windows IFACE libs are static only
  ...
  #           "../compiler/lib/${MKL_ARCH}_lin"
  #           "../compiler/lib/${MKL_ARCH}_win"
  #           "../compiler/lib/${MKL_ARCH}"
  #           "../compiler/lib"
  ...
  #             "redist/${MKL_ARCH}_win/compiler"
  #             "../redist/${MKL_ARCH}/compiler"
  #             "../compiler/lib"
  ...
  #       set(SYCL_LIB_VER "")
  #       find_library(
  #         SYCL_LIB_DIR ${LIB_PREFIX}sycl${LIB_EXT}
  #         HINTS $ENV{LIB} $ENV{CMPLR_ROOT}
  #         PATH_SUFFIXES "windows/lib")
  #       if(NOT SYCL_LIB_DIR)
  #         foreach(ver RANGE 6 99 1)
  #           find_library(
  #             SYCL_LIB_DIR ${LIB_PREFIX}sycl${ver}${LIB_EXT}
  #             HINTS $ENV{LIB} $ENV{CMPLR_ROOT}
  #             PATH_SUFFIXES "windows/lib")
  #           if(SYCL_LIB_DIR)
