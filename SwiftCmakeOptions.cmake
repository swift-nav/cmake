...
function(swift_create_project_options)
  ...
  if(build_tests OR build_test_libs)
    ...
    if(x_HAS_TESTS)
      set(${x_PROJECT}_BUILD_TESTS ${test_components_possible} CACHE BOOL "Build unit tests for ${x_PROJECT}")
    endif()
    if(x_HAS_TEST_LIBS)
      set(${x_PROJECT}_BUILD_TEST_LIBS ${test_components_possible} CACHE BOOL "Build test libraries for ${x_PROJECT}")
    endif()
  endif()
