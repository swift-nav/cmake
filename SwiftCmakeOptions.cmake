...
function(swift_create_project_options)
  ...
  if(x_HAS_TESTS)
    ...
    if(${x_PROJECT}_ENABLE_TESTS)
      if(test_components_possible)
        ...
        message(WARNING "${x_PROJECT} unit tests explicitly enabled but it isn't possible to build them")
      endif()
    else()
  ...
  if(x_HAS_TEST_LIBS)
    ...
    if(${x_PROJECT}_ENABLE_TEST_LIBS)
      if(test_components_possible)
        set(${x_PROJECT}_BUILD_TESTS TRUE CACHE BOOL "Build test libraries for ${x_PROJECT}")
      else()
        message(WARNING "${x_PROJECT} test libraries are explicitly enabled but it isn't possible to build them")
      endif()
    else()
